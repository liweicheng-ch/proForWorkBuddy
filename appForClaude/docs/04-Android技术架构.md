...
│   ├── tts/TtsManager.kt
│   ├── resource/ResourceManager.kt  // 统一资源管理 (图片/音频/字体/JSON)
...
│   └── usecase/
│       ├── DifficultyManager.kt    // 难度自适应逻辑
│       ├── AdventureMissionManager.kt // 冒险任务编排
│       ├── ScoreManager.kt         // 计分与激励算法
│       ├── ProgressManager.kt      // 每日任务与进度追踪
│       ├── ReadingProfileManager.kt // 阅读多维能力画像
│       └── ErrorAnalysisManager.kt // 错题分析与巩固路径
├── feature/
│   ├── home/  首页 (activity/fragment + xml + viewmodel)
│   ├── learn/  学习中心
│   ├── ability/  能力详情
│   ├── reading/  阅读中心 (含 ReadingEngine)
│   ├── game/  游戏容器
│   ├── onboarding/  首次启动
│   ├── profile/  我的
│   ├── parent/  家长中心
